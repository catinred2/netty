 ...
 * </p>
 *
 * @see org.EasyTimerCalendar.Calendar
 *
 * @author Juergen Donnerstag
 * @author James House
 */
public class BaseCalendar implements EasyTimerCalendar, Serializable, Cloneable {

    static final long serialVersionUID = 3106623404629760239L;

    // <p>A optional base calendar.</p>
    private EasyTimerCalendar baseCalendar;
    ...
    public BaseCalendar(EasyTimerCalendar baseCalendar) {
     ...
     * if <code>{@link TimeZone#getDefault()}</code> should be used
     */
    public BaseCalendar(EasyTimerCalendar baseCalendar, TimeZone timeZone) {
        setBaseCalendar(baseCalendar);
        setTimeZone(timeZone);
    }
    ...
    public Object clone()  {
        try {
            ...
            if (getBaseCalendar() != null) {
                clone.baseCalendar = (EasyTimerCalendar) getBaseCalendar().clone();
            }
            if(getTimeZone() != null)
     ...
     * </p>
     */
    public void setBaseCalendar(EasyTimerCalendar baseCalendar) {
     ...
     * </p>
     */
    public EasyTimerCalendar getBaseCalendar() {
     ...
     * </p>
     *
     * @see org.EasyTimerCalendar.Calendar#isTimeIncluded(long)
     */
     ...
     * </p>
     *
     * @see org.EasyTimerCalendar.Calendar#getNextIncludedTime(long)
     */
